...
// SentMessages is a free data retrieval call binding the contract method 0xbc294d7d.
//
// Solidity: function sentMessages(uint256 ) view returns(bytes32)
func (_L2ToL2CrossDomainMessenger *L2ToL2CrossDomainMessengerCaller) SentMessages(opts *bind.CallOpts, arg0 *big.Int) ([32]byte, error) {
	var out []interface{}
...
//
// Solidity: function sentMessages(uint256 ) view returns(bytes32)
func (_L2ToL2CrossDomainMessenger *L2ToL2CrossDomainMessengerSession) SentMessages(arg0 *big.Int) ([32]byte, error) {
...
//
// Solidity: function sentMessages(uint256 ) view returns(bytes32)
func (_L2ToL2CrossDomainMessenger *L2ToL2CrossDomainMessengerCallerSession) SentMessages(arg0 *big.Int) ([32]byte, error) {
	return _L2ToL2CrossDomainMessenger.Contract.SentMessages(&_L2ToL2CrossDomainMessenger.CallOpts, arg0)
}
