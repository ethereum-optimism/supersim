import {
  ...
  injected,
  mock
} from "./chunk-7CTLNJT7.js";
import "./chunk-FOYRTY5N.js";
import {
  ChainNotConfiguredError,
  ProviderNotFoundError
} from "./chunk-5V23P7CV.js";
import {
  withRetry,
  withTimeout
} from "./chunk-M4TJ2S43.js";
import "./chunk-MX3JSGJB.js";
import {
  ...
  hexToNumber,
  numberToHex
} from "./chunk-EDSVFLUV.js";
import "./chunk-7E7THS5F.js";
    ...
    async getProvider() {
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-AXYCGWBK.js");
...
function version3(parameters) {
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-B5PZO247.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
    ...
    async getProvider() {
      async function initProvider() {
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./metamask-sdk-NBP2UM7D.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-QRHZSAPZ.js");
        ...
        const { SafeAppProvider } = await import("./dist-PU3HX4U4.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-JBQKNYUV.js");
