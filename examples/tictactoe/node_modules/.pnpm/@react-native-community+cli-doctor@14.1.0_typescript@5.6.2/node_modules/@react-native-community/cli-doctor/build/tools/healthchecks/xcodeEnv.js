...
var _default = {
  ...
  getDiagnostics: async (_, config) => {
    try {
      ...
      const missingXcodeEnvFile = (0, _cliPlatformApple().findPodfilePaths)(iosFolderPath).some(podfilePath => {
  ...
  runAutomaticFix: async ({
    ...
    try {
      ...
      (0, _cliPlatformApple().findPodfilePaths)(iosFolderPath).map(podfilePath => removeLastPathComponent(_path().default.join(iosFolderPath, podfilePath)))
...
//# sourceMappingURL=/Users/thymikee/Developer/oss/rncli/packages/cli-doctor/build/tools/healthchecks/xcodeEnv.js.map