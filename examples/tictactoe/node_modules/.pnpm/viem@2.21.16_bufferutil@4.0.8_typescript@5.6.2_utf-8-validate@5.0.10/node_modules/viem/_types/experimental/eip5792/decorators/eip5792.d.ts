...
export type Eip5792Actions<chain extends Chain | undefined = Chain | undefined, account extends Account | undefined = Account | undefined> = {
     ...
     * })
     */
    getCapabilities: (...parameters: account extends Account ? [] | [parameters: GetCapabilitiesParameters<account>] : [parameters: GetCapabilitiesParameters<undefined>]) => Promise<GetCapabilitiesReturnType>;
    /**
