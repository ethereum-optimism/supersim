...
const MarketBetModal: React.FC<MarketBetModalProps> = ({ isOpen, chainId, data, outcome, yesOdds, yesText, noText, market, onClose }) => {
        ...
        <div style={styles.overlay}>
            <div style={styles.modal}>
                <div style={styles.header}>
                    <div style={styles.title}>Place bet</div>
                    <button style={styles.closeButton} onClick={onClose}>×</button>
                </div>

                <div style={styles.content}>
                    <div style={{...styles.content, borderBottom: '1px solid #e0e0e0'}}>
