...
contract PredictionMarket {
    ...
    event LiquidityRedeemed(IMarketResolver indexed resolver, address indexed redeemer, uint256 outcomeAmountOut);
    ...
    event OutcomeRedeemed(IMarketResolver indexed resolver, address indexed redeemer, MarketOutcome outcome, uint256 amount);
    ...
    function redeemLP(IMarketResolver _resolver) public {
        ...
        // Return appropriate share the winning outcomes.
        if (market.outcome == MarketOutcome.YES) {
            ...
            emit LiquidityRedeemed(_resolver, msg.sender, yesAmount);
        } else {
            ...
            emit LiquidityRedeemed(_resolver, msg.sender, noAmount);
        }
