...
generate-monorepo-bindings: install-abigen
    ./scripts/generate-bindings.sh -u $(just calculate-artifact-url) -n CrossL2Inbox,L2ToL2CrossDomainMessenger,L1Block,SuperchainETHBridge,SuperchainERC20,SuperchainTokenBridge,DisputeGameFactory,PermissionedDisputeGame -o ./bindings
